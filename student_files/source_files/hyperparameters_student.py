...
# MAGIC 
# MAGIC 2 -> Minimum samples allowed per tree split iteration--reduces overfitting for the same reason as the previous hyperparameter--by disallowing trees from learning overly specific dynamics
# MAGIC 
